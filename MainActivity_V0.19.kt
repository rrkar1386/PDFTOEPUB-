 ...
 *
 * V0.18 continues the V0.17 reconstruction pipeline without replacing its geometry.
...
data class AnalysisOutput(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val title = TextView(this).apply {
            text = "PDF → EPUB\nV0.18 — Contextual Structural Repair + Glossary + Intentional Layout"
            textSize = 28f
        }
