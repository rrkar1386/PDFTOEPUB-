...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val title = TextView(this).apply {
            text = "PDF → EPUB\nV0.17 — Contextual Structural Repair + Intentional Layout"
            textSize = 28f
        }
    ...
    private fun analyzeDocument(input: InputStream): String {
        PDDocument.load(input).use { doc ->
            ...
            val pages = rawPages.map { rawPage ->
                ...
                PageModel(rawPage.pageNumber, rawPage.width, rawPage.height, filtered, regions, classified, intentionalWhitespace)
            }
    ...
    private fun classifyBlocks(blocks: List<Block>, pageNumber: Int, pageCount: Int, pageWidth: Float, pageHeight: Float): List<ClassifiedBlock> {
        ...
        val classified = blocks.mapIndexed { index, block ->
            ...
            ClassifiedBlock(
                ...
                typeAndConfidence.first, typeAndConfidence.second, block.regionId,
    ...
    /**
     * V0.17 contextual structural repair and intentional-layout recognition.
     *
